...
OMACMUX_LINKS=(
  ...
  "additive:config/pi/extensions/omacmux-pi:$HOME/.pi/agent/extensions/omacmux-pi"
  "additive:config/pi/skills/omacmux:$HOME/.pi/agent/skills/omacmux"
  "additive:config/pi/prompts/omacmux-swarm.md:$HOME/.pi/agent/prompts/omacmux-swarm.md"
  "additive:config/pi/prompts/omacmux-worktree.md:$HOME/.pi/agent/prompts/omacmux-worktree.md"
  "additive:config/pi/prompts/omacmux-review.md:$HOME/.pi/agent/prompts/omacmux-review.md"
  "additive:config/pi/prompts/omacmux-handoff.md:$HOME/.pi/agent/prompts/omacmux-handoff.md"
